/**
 * Analytics General Tab
 * General analytics tab with comprehensive pitch deck evaluation
 * Original VC Feedback tab content
 */
...
export function AnalyticsGeneralTab({ deckId }: AnalyticsGeneralTabProps) {
